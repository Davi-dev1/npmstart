           ...
           <img src={img} className='i'  alt='i' height='40' width='40'/>
            ...
            <div>
                <ul className='menulateral'>
                    ...
                    <Listitem texto='Home' icone={<FaHouse  style={{color:'#8e8e8e'}} /> }/>
                    ...
                    <Listitem texto='Perfil' icone={ <CgProfile  style={{color:'black'}} />} />
                    <Listitem texto='Mais' icone={<IoIosOptions style={{color:'black'}}   />} />
